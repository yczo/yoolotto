...
//     if((US_State == 2 || US_State == 3) && (strcmp(fieldName, "DATEA") == 0 || strcmp(fieldName, "DATEN") == 0)) bigFlag = 1;
     if((strcmp(fieldName, "DATEA") == 0 || strcmp(fieldName, "DATEN") == 0)) bigFlag = 1;
...
//    }
    ...
    if((US_State == 0  || US_State == 1 || US_State == 3) && (strcmp(fieldName, "DATEA") == 0 || strcmp(fieldName, "DATEN") == 0|| strcmp(fieldName, "LOGO3") == 0)) {segmMode = 0; lpWorkBuffer->flgUNP = 0;}
    if((US_State == 0 || US_State == 1 ) && (strcmp(fieldName, "NUMBERS") == 0 || strcmp(fieldName, "NUMBERS1") == 0)){
	   switch(ticketTypeInt){
//	    case 0: // LOTTO TEXAS
//	   break;
//	case 1: // PICK 3
