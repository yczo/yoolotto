...
class LotteryTicket(models.Model):
    ...
    def update1(self, multicoin,countt, device=None, Client_login=None, full=False):
        if full:
    ...
    def update_coins1(self, device,countt, Client_login, save=False):
        print 1111111111111111119999999999999999999999999999999999999999999999999
...
class LotteryTicketPlay(models.Model):
    ...
    def update_winnings(self,save=True):
        ...
        if self.ticket.fantasy == False:    
            ...
            print "in update winnings Fantasyyy"
            if self.ticket.draw.result:
